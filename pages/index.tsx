      ...
      <main className="grow">
        <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
          ...
          <p className="px-3 pb-4 pt-2 text-justify">
            ...
            ist, dass Sie ein Fahrrad finden, das die optimale Passform und Ergonomie für Sie bietet. Sollten Sie sich
            dafür entscheiden, ein Fahrrad zu kaufen, richten wir es Ihnen natürlich ein und passen es Ihren Wünschen
            an.
          </p>
          <h2 className="px-4 text-2xl font-bold text-teal-900">Gebraucht Fahrräder</h2>
          <p className="px-3 pb-4 pt-2 text-justify">
            Sollten Sie sich für ein gebrauchtes Rad interessieren oder wollen Sie ihr aktuelles Rad verkaufen, zögern
            Sie nicht, uns zu kontaktieren. Wir vermitteln gerne gebrauchte Räder und rechnen Ihnen den Preis auf ihr
            neues Rad an.
          </p>
