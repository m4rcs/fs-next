...
export default function Impress() {
  return (
    <Content name="Impressum">
      <div className="px-4 text-lg font-bold text-teal-900">Angaben gemäß § 5 TMG</div>
      <p>
        Fahrrad-Strutt GbR
        <br />
        Gartenstraße 4<br />
      ...
      <div className="px-4 font-bold text-teal-900">Vertreten durch die Gesellschafter:</div>
      <p>Rüdiger und Eberhard Strutt</p>
      <div className="px-4 text-lg font-bold text-teal-900">Kontakt</div>
      <p>
