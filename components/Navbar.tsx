              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <Link className="no-underline" href="./">
                  <div className="flex flex-shrink-0 items-center">
                    <FontAwesomeIcon icon={faBicycle} className="inline-block h-8 w-auto text-gray-200 lg:hidden" />
                    <FontAwesomeIcon icon={faBicycle} className="hidden h-8 w-auto text-gray-200 lg:inline-block" />
                    <span className="hidden h-8 w-auto px-3 font-logo text-2xl text-gray-200 lg:inline-block">
                      Fahrrad Strutt
                    </span>
                  </div>
                </Link>
